...
public class Zoomer {
    ...
    private static final String TAG = Zoomer.class.getSimpleName();
    /**
    ...
    public Zoomer(Context context) {
        mInterpolator = new DecelerateInterpolator(); // 减速插值器
        mAnimationDurationMillis = context.getResources().getInteger(
                android.R.integer.config_shortAnimTime); // 短动画时长
    }
...
//        Log.d(TAG, "startZoom: endZoom = " + endZoom);
    ...
    public boolean computeZoom() {
        if (mFinished) {
//            Log.d(TAG, "computeZoom: return false");
            return false;
        }
...
//        Log.d(TAG, "computeZoom: return true");
        return true;
    }
